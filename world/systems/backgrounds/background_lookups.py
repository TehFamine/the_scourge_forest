...
CHARACTER_BACKGROUNDS = {
	...
	"knight":
		{"skills": {"history": [True, "int"], "persuasion": [True, "cha"]},
		 "equiptment": [],
		 "languages": [1, lang.LANGUAGES['standard'] + lang.LANGUAGES['exotic']],
		 "proficiences": [1, ["dice", "dragonchess", "playing cards", "three-dragon ante"]],
		 "traits": ["position of privilege"],
		 "belt_pouch": 2500,
		 "special": {},
		 "personality trait": {1: "My eloquent flattery makes everyone I talk to feel like the most wonderful and "
								  "important person in the world.",
							   2: "The common folk love me for my kindness and generosity.",
							   3: "No one could doubt by looking at my regal bearing that I am a cut "
								  "above the unwashed masses.",
							   4: "I take great pains to always look my best and follow the latest fashions.",
							   5: "I don't like to get my hands dirty, and I won't be caught dead "
								  "in unsuitable accommodations.",
							   6: "Despite my noble birth, I do not place myself above other folk. We "
								  "all have the same blood.",
							   7: "My favor, once lost, is lost forever.",
							   8: "If you do me an injury, I will crush you, ruin your name, and salt your fields."},
		 "ideal": {1: "Respect. Respect is due to me because of my position, but all people regardless of station "
					  "deserve to be treated with dignity.",
				   2: "Responsibility. It is my duty to respect the authority of those above me, just as those "
		 ...
		 "bond": {1: "I will face any challenge to win the approval of my family.",
				  2: "My house's alliance with another noble family must be sustained at all costs.",
				  3: "Nothing is more important than the other members of my family.",
				  4: "I am in love with the heir of a family that my family despises.",
				  5: "My loyalty to my sovereign is unwavering.",
				  6: "The common folk must see me as a hero of the people."},
		 "flaw": {1: "I secretly believe that everyone is beneath me.",
	...
	"outlander":
		{"skills": {"athletics": [True, "str"], "survival": [True, "wis"]},
		 "equiptment": [],
		 "languages": [1, lang.LANGUAGES['standard'] + lang.LANGUAGES['exotic']],
		 "proficiences": [1, ["bagpipes", "drum", "flute", "lute", "lyre", "horn", "pan flute", "shawm", "viol"]],
		 "traits": ["wanderer"],
		 ...
		 "personality trait": {1: "I'm driven by a wanderlust that led me away from home.",
							   ...
							   3: "I once ran twenty-five miles without stopping to warn my clan of an "
								  "approaching orc horde. I'd do it again if I had to.",
							   4: "I have a lesson for every situation, drawn from observing nature.",
							   5: "I place no stock in wealthy or well-mannered folk. Money and manners won't "
								  "save you from a hungry owlbear.",
							   6: "I'm always picking things up, absently fiddling with them, and sometimes "
								  "accidentally breaking them.",
							   7: "I feel far more comfortable around animals than people.",
							   8: "I was, in fact, raised by wolves."},
		 "ideal": {1: "Change. Life is like the seasons, in constant change, and we must change with it.",
		 ...
		 "bond": {1: "My family, clan, or tribe is the most important thing in my life, even when they are far from me.",
				  2: "An injury to the unspoiled wilderness of my home is an injury to me.",
				  3: "I will bring terrible wrath down on the evildoers who destroyed my homeland.",
				  4: "I am the last of my tribe, and it is up to me to ensure their names enter legend.",
				  5: "I suffer awful visions of a coming disaster and will do anything to prevent it.",
				  6: "It is my duty to provide children to sustain my tribe."},
		 "flaw": {1: "I am too enamored of ale, wine, and other intoxicants.",
				  2: "There's no room for caution in a life lived to the fullest.",
				  3: "I remember every insult I've received and nurse a silent resentment toward anyone who's ever wronged me.",
				  4: "I am slow to trust members of other races, tribes, and societies.",
				  5: "Violence is my answer to almost any challenge.",
				  6: "Don't expect me to save those who can't save themselves. It is nature's way that the "
					 "strong thrive and the weak perish."}},

	"pirate":
		{"skills": {"athletics": [True, "str"], "perception": [True, "wis"]},
		 "equiptment": [],
		 "languages": [],
		 "proficiences": [2, ["navigators tools", "vehicles (water)"]],
		 ...
		 "ideal": {1: "Respect. The thing that keeps a ship together is mutual respect between captain and crew.",
		 ...
		 "bond": {1: "I'm loyal to my captain first, everything else second.",
		 ...
		 "flaw": {1: "I follow orders, even if I think they're wrong.",
